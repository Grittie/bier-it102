                ...
                <tbody>
                    @foreach ($users as $key => $user)
                        <tr class="hover:bg-gray-100">
                            ...
                            <td class="py-4 px-6 text-gray-700 border-b text-left">{{ $user->scores->pitchers ?? 0 }}</td>
                            <td class="py-4 px-6 text-gray-700 border-b text-left">{{ ($user->scores->pitchers ?? 0) * 1.8 }} L</td>
                            <td class="py-4 px-6 text-gray-700 border-b text-left">€ {{ ($user->scores->pitchers ?? 0) * 14 }}</td>
                        </tr>
                    @endforeach
                </tbody>
            </table>
